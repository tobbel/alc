...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 3],
...
["dart.dom.html", "dart:html", , W, {
  ...
  EventTarget: {
    "^": "Interceptor;",
    "%": "AnimationPlayer|ApplicationCache|AudioContext|BatteryManager|DOMApplicationCache|DedicatedWorkerGlobalScope|EventSource|FileReader|IDBDatabase|IDBOpenDBRequest|IDBRequest|IDBTransaction|IDBVersionChangeRequest|InputMethodContext|MIDIAccess|MediaController|MediaKeySession|MediaSource|MessagePort|Notification|OfflineAudioContext|OfflineResourceList|Performance|RTCDTMFSender|RTCPeerConnection|ServiceWorker|ServiceWorkerGlobalScope|ServiceWorkerRegistration|SharedWorker|SharedWorkerGlobalScope|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|Worker|WorkerGlobalScope|mozRTCPeerConnection|webkitAudioContext;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
  },
  FieldSetElement: {
    "^": "HtmlElement;type=",
    "%": "HTMLFieldSetElement"
...
["dart.dom.indexed_db", "dart:indexed_db", , P, {
  ...
  Cursor: {
    ...
    }, "next$0", "call$1", "call$0", "get$next", 0, 2, 0, 1],
    "%": ";IDBCursor"
  },
  CursorWithValue: {
    "^": "Cursor;",
...
["", "index.dart", , E, {
  ...
  init: function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, geometry, i, line;
    ...
    t15.setValues$3(1, 0, 0);
    t16.push(t15);
    t15 = geometry.vertices;
    t16 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t16.setValues$3(1, 1, 0);
    t15.push(t16);
    t16 = geometry.vertices;
    t15 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t15.setValues$3(0, 0, 0);
    t16.push(t15);
    t15 = geometry.faces;
    t16 = [0, 1, 2];
    t14 = new S.Face3(t16, null, null, null, null, null, null, null);
    t14.Face$4(t16, null, null, null);
    t15.push(t14);
    t14 = S.Color$(13369344);
    ...
    t2 = $.MaterialCount;
    $.MaterialCount = t2 + 1;
    t2 = S.Mesh$(geometry, new S.MeshLambertMaterial(null, t14, t15, t16, null, false, t1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, 0, "", t2, 0, S.Color$(13369344), 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, true, 0, null, null, null, null, null, false));
    $.mesh = t2;
    t1 = new T.Vector3(new Float32Array(H._checkLength(3)));
    ...
    for (i = 0; i < 100; ++i) {
      ...
      t5[1] = t3 * 2;
      t5[2] = 0;
      t4.push(new T.Vector3(t5));
    }
    line = S.Line$(geometry, new S.LineBasicMaterial(100, "round", "round", "", t1, 0, t2, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, true, 0, null, null, null, null, null, false), 0);
    $.scene.add$1(0, line);
    ...
    if (typeof t2 !== "number")
      return H.iae(t2);
    J.set$width$x(t3, C.JSNumber_methods.toInt$0(t5 * t2));
    t2 = t6.canvas;
    t3 = t6.devicePixelRatio;
    if (typeof t4 !== "number")
      return t4.$mul();
    if (typeof t3 !== "number")
      return H.iae(t3);
    J.set$height$x(t2, C.JSNumber_methods.toInt$0(t4 * t3));
    J.set$width$x(t6.canvas.style, "" + t5 + "px");
...
["three", "package:three/three.dart", , S, {
  ...
  Frustum: {
    ...
    contains$1: function(_, object) {
      ...
      radius = -object.geometry.boundingSphere.radius * Math.sqrt(H.checkNum(P.max(m.$index(0, 0) * m.$index(0, 0) + m.$index(0, 1) * m.$index(0, 1) + m.$index(0, 2) * m.$index(0, 2), P.max(m.$index(0, 4) * m.$index(0, 4) + m.$index(0, 5) * m.$index(0, 5) + m.$index(0, 6) * m.$index(0, 6), m.$index(0, 8) * m.$index(0, 8) + m.$index(0, 9) * m.$index(0, 9) + m.$index(0, 10) * m.$index(0, 10)))));
  ...
  Object_WebGLGeometry: {
    "^": "Object+WebGLGeometry;id:three$WebGLGeometry$id*,faces3:three$WebGLGeometry$faces3<,geometryGroups:three$WebGLGeometry$geometryGroups@,geometryGroupsList:three$WebGLGeometry$geometryGroupsList@,__webglVertexBuffer:three$WebGLGeometry$__webglVertexBuffer@,__webglNormalBuffer:three$WebGLGeometry$__webglNormalBuffer?,__webglTangentBuffer:three$WebGLGeometry$__webglTangentBuffer?,__webglColorBuffer:three$WebGLGeometry$__webglColorBuffer@,__webglLineDistanceBuffer:three$WebGLGeometry$__webglLineDistanceBuffer@,__webglFaceBuffer:three$WebGLGeometry$__webglFaceBuffer<,__webglLineBuffer:three$WebGLGeometry$__webglLineBuffer<,__webglMorphTargetsBuffers:three$WebGLGeometry$__webglMorphTargetsBuffers<,__webglInit:three$WebGLGeometry$__webglInit@,__inittedArrays:three$WebGLGeometry$__inittedArrays<,__vertexArray:three$WebGLGeometry$__vertexArray@,__colorArray:three$WebGLGeometry$__colorArray@,__lineDistanceArray:three$WebGLGeometry$__lineDistanceArray@,__webglFaceCount:three$WebGLGeometry$__webglFaceCount<,__webglLineCount:three$WebGLGeometry$__webglLineCount@,__webglCustomAttributesList:three$WebGLGeometry$__webglCustomAttributesList<"
  },
  ...
  MeshLambertMaterial: {
    "^": "Material;_parameters,color:three$MeshLambertMaterial$color>,ambient,emissive,specular,wrapAround,wrapRGB,map>,lightMap<,specularMap<,envMap<,combine<,reflectivity<,refractionRatio<,shading<,wireframe<,wireframeLinewidth<,wireframeLinecap,wireframeLinejoin,skinning<,morphTargets<,morphNormals<,numSupportedMorphTargets@,numSupportedMorphNormals@,name,id,side,color,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,fog,vertexColors,_program,_fragmentShader,_vertexShader,_uniforms,_uniformsList,shadowPass",
  ...
  Mesh: {
    "^": "Object3D;material:three$Mesh$material<,morphTargetBase,morphTargetForcedOrder,morphTargetInfluences,_morphTargetDictionary,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,geometry,material,__webglInit,__webglActive,immediateRenderCallback,_modelViewMatrix,_normalMatrix,count,hasPositions,hasNormals,hasUvs,hasColors,positionArray,normalArray,uvArray,colorArray,__webglVertexBuffer,__webglNormalBuffer,__webglUVBuffer,__webglColorBuffer,__webglMorphTargetInfluences",
    ...
    static: {Mesh$: function(geometry, material) {
        ...
        t9 = new T.Matrix4(new Float32Array(H._checkLength(16)));
        t9.setIdentity$0();
        t9 = new S.Mesh(material, 0, null, null, null, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, T.Quaternion$identity(), false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(H._checkLength(3))), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  ...
  WebGLRenderer: {
    ...
    initMeshBuffers$2: function(geometryGroup, object) {
      ...
      t2 = faces4.length;
      nvertices = t1 * 3 + t2 * 4;
      material = object.three$Mesh$material;
      ...
      if (geometry.hasTangents)
        geometryGroup.three$WebGLGeometry$__tangentArray = new Float32Array(nvertices * 4);
      if (material.vertexColors !== 0)
        geometryGroup.three$WebGLGeometry$__colorArray = new Float32Array(t3);
      if (uvType) {
        geometry.faceUvs;
        geometryGroup.three$WebGLGeometry$__uvArray = new Float32Array(nvertices * 2);
    ...
    setMeshBuffers$5: function(geometryGroup, object, hint, dispose, material) {
      var normalType, needsSmoothNormals, vertexArray, uvArray, uv2Array, normalArray, tangentArray, colorArray, morphTargetsArrays, morphNormalsArrays, customAttributes, faceArray, lineArray, geometry, dirtyVertices, dirtyElements, dirtyUvs, dirtyNormals, dirtyTangents, dirtyColors, dirtyMorphTargets, vertices, chunk_faces3, chunk_faces4, obj_faces, t1, obj_uvs, morphTargets, morphNormals, fl, f, face, v1, v2, v3, offset, t2, t3, t4, v4, n1, n2, n3, n4, vk, vka, nka, chf, faceVertexNormals, offset_morphTarget, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, offset_color, vertexColors, faceColor, c1, c2, c3, c4, offset_tangent, vertexTangents, vn, offset_normal, vertexNormals, faceNormal, i, uvi, offset_uv, fi, uv, uv2i, offset_uv2, uv2, vertexIndex, offset_face, offset_line, il, offset_custom, offset_customSrc, value;
      if (geometryGroup.get$__inittedArrays() !== true)
        return;
      normalType = this.bufferGuessNormalType$1(material);
      this.bufferGuessUVType$1(material);
      needsSmoothNormals = normalType === 2;
      vertexArray = geometryGroup.three$WebGLGeometry$__vertexArray;
      uvArray = geometryGroup.three$WebGLGeometry$__uvArray;
      uv2Array = geometryGroup.three$WebGLGeometry$__uv2Array;
      normalArray = geometryGroup.three$WebGLGeometry$__normalArray;
      tangentArray = geometryGroup.three$WebGLGeometry$__tangentArray;
      colorArray = geometryGroup.three$WebGLGeometry$__colorArray;
      morphTargetsArrays = geometryGroup.three$WebGLGeometry$__morphTargetsArrays;
      morphNormalsArrays = geometryGroup.three$WebGLGeometry$__morphNormalsArrays;
      customAttributes = geometryGroup.three$WebGLGeometry$__webglCustomAttributesList;
      faceArray = geometryGroup.three$WebGLGeometry$__faceArray;
      lineArray = geometryGroup.three$WebGLGeometry$__lineArray;
      geometry = object.geometry;
      dirtyVertices = geometry.verticesNeedUpdate;
      ...
      vertices = geometry.vertices;
      chunk_faces3 = geometryGroup.three$WebGLGeometry$faces3;
      chunk_faces4 = geometryGroup.three$WebGLGeometry$faces4;
      ...
      if (dirtyVertices) {
        ...
        J.bindBuffer$2$x(this._gl, 34962, geometryGroup.three$WebGLGeometry$__webglVertexBuffer);
        J.bufferDataTyped$3$x(this._gl, 34962, vertexArray, hint);
      } else {
        f = null;
        fl = null;
      ...
      if (dirtyMorphTargets)
        for (t1 = !!material.$isMorphing, n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; false; ++vk) {
          ...
          for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
            ...
            vka[t10] = t11;
            if (t1 && material.get$morphNormals()) {
              t3 = morphNormals[vk];
          ...
          t2 = this._gl;
          t3 = geometryGroup.three$WebGLGeometry$__webglMorphTargetsBuffers;
          if (vk >= t3.length)
          ...
          if (t1 && material.get$morphNormals()) {
            t2 = this._gl;
            t3 = geometryGroup.three$WebGLGeometry$__webglMorphNormalsBuffers;
            if (vk >= t3.length)
              return H.ioore(t3, vk);
            J.bindBuffer$2$x(t2, 34962, t3[vk]);
            t3 = this._gl;
      ...
      if (dirtyElements) {
        ...
        J.bindBuffer$2$x(this._gl, 34963, geometryGroup.three$WebGLGeometry$__webglFaceBuffer);
        J.bufferDataTyped$3$x(this._gl, 34963, faceArray, hint);
        J.bindBuffer$2$x(this._gl, 34963, geometryGroup.three$WebGLGeometry$__webglLineBuffer);
      ...
      if (dispose) {
        geometryGroup.three$WebGLGeometry$__inittedArrays = false;
        geometryGroup.three$WebGLGeometry$__colorArray = null;
        geometryGroup.three$WebGLGeometry$__normalArray = null;
        geometryGroup.three$WebGLGeometry$__tangentArray = null;
        geometryGroup.three$WebGLGeometry$__uvArray = null;
        geometryGroup.three$WebGLGeometry$__uv2Array = null;
        geometryGroup.three$WebGLGeometry$__faceArray = null;
        geometryGroup.three$WebGLGeometry$__vertexArray = null;
        geometryGroup.three$WebGLGeometry$__lineArray = null;
        geometryGroup.three$WebGLGeometry$__skinIndexArray = null;
        geometryGroup.three$WebGLGeometry$__skinWeightArray = null;
      }
    },
    ...
    renderBuffer$6: function(camera, lights, fog, material, geometryGroup, object) {
      ...
      if (updateBuffers) {
        if (geometryGroup.get$__webglCustomAttributesList() != null) {
          ...
          for (i = 0; i < il; ++i) {
            t3 = geometryGroup.three$WebGLGeometry$__webglCustomAttributesList;
            if (i >= t3.length)
              return H.ioore(t3, i);
            attribute = t3[i];
      ...
      if (!!object.$isMesh) {
        ...
        t1 = t1.render;
        t4 = t1.faces;
        t3 = geometryGroup.three$WebGLGeometry$__webglFaceCount;
        if (typeof t3 !== "number")
          return t3.$tdiv();
      ...
      for (influenceIndex = null, m = 0; m < material.get$numSupportedMorphTargets();) {
        ...
        if (t2) {
          ...
          if (material.get$morphNormals()) {
            t1 = this._gl;
            t2 = geometryGroup.three$WebGLGeometry$__webglMorphNormalsBuffers;
    ...
    sortFacesByMaterial$2: function(geometry, material) {
      ...
      for (f = 0; f < fl; ++f) {
        ...
        if (geometry.get$geometryGroups().$index(0, groupHash) == null) {
          ...
          t2.three$WebGLGeometry$faces3 = [];
          t2.three$WebGLGeometry$faces4 = [];
          t2.three$WebGLGeometry$materialIndex = H.Primitives_parseInt("0", null, null);
          t2.three$WebGLGeometry$verticesCount = 0;
          t2.three$WebGLGeometry$numMorphTargets = 0;
          t2.three$WebGLGeometry$numMorphNormals = 0;
          t1.$indexSet(0, groupHash, t2);
        }
        t1 = geometry.get$geometryGroups().$index(0, groupHash).three$WebGLGeometry$verticesCount;
        if (typeof t1 !== "number")
          return t1.$add();
        if (t1 + 3 > 65535) {
        ...
        geometry.get$geometryGroups().$index(0, groupHash).three$WebGLGeometry$faces3.push(f);
        t1 = geometry.get$geometryGroups().$index(0, groupHash);
        t2 = t1.three$WebGLGeometry$verticesCount;
        if (typeof t2 !== "number")
          return t2.$add();
        t1.three$WebGLGeometry$verticesCount = t2 + 3;
      }
    ...
    initMaterial$4: function(material, lights, fog, object) {
      var shaderID, t1, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, attributes, i;
      ...
      t6 = !!material.$isTextureMapping ? material.get$map(material) : null;
      t7 = !!material.$isEnvironmentMapping;
      t8 = t7 ? material.get$envMap() : null;
      t9 = t7 ? material.get$lightMap() : null;
      t7 = t7 ? material.get$specularMap() : null;
      ...
      t24 = !!material.$isLighting && material.wrapAround;
      t25 = material.side;
      t24 = this.buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround(shaderID, t1, t2, t3, t5, t4, material.alphaTest, 0, 0, null, t25 === 2, t8, t25 === 1, fog, false, t9, t6, maxBones, t19, t22, t18, t17, t20, maxShadows, t21, false, t16, t15, null, false, this.shadowMapCascade, this.shadowMapDebug, t23, this.shadowMapType, false, t12, t7, t11, t13, t10, t24);
      material._program = t24;
      attributes = t24.attributes;
    ...
    setProgram$5: function(camera, lights, fog, material, object) {
      ...
      if (refreshMaterial) {
        ...
        if (!!t1.$isLineBasicMaterial) {
          ...
          t2 = material.ambient;
          t3 = material.emissive;
          if (this.gammaInput) {
            J.get$value$x(m_uniforms.$index(0, "ambient")).copyGammaToLinear$1(t2);
            J.get$value$x(m_uniforms.$index(0, "emissive")).copyGammaToLinear$1(t3);
          } else {
            J.set$value$x(m_uniforms.$index(0, "ambient"), t2);
            J.set$value$x(m_uniforms.$index(0, "emissive"), t3);
          }
          if (material.wrapAround)
            J.get$value$x(m_uniforms.$index(0, "wrapRGB")).copy$1(material.wrapRGB);
        }
  ...
  WebGLRenderer_initCustomAttributes_closure: {
    "^": "Closure:12;this_0,geometry_1,nvertices_2",
  ...
  WebGLRenderer_initMeshBuffers_closure: {
    "^": "Closure:12;this_0,geometryGroup_1,nvertices_2",
    call$2: function(key, attribute) {
  ...
  WebGLRenderer_renderPlugins_closure: {
    "^": "Closure:13;this_0,scene_1,camera_2",
  ...
  WebGLRenderer_addObject_closure: {
    "^": "Closure:12;this_0,object_1,geometry_2",
  ...
  WebGLRenderer_addObject_closure0: {
    "^": "Closure:12;this_3,object_4,scene_5",
    call$2: function(k, geometryGroup) {
  ...
  WebGLGeometry: {
    "^": "Object;id:three$WebGLGeometry$id*,three$WebGLGeometry$verticesCount,faces3:three$WebGLGeometry$faces3<,three$WebGLGeometry$faces4,three$WebGLGeometry$numMorphTargets,three$WebGLGeometry$numMorphNormals,three$WebGLGeometry$materialIndex,geometryGroups:three$WebGLGeometry$geometryGroups@,geometryGroupsList:three$WebGLGeometry$geometryGroupsList@,__webglVertexBuffer:three$WebGLGeometry$__webglVertexBuffer@,__webglNormalBuffer:three$WebGLGeometry$__webglNormalBuffer?,__webglTangentBuffer:three$WebGLGeometry$__webglTangentBuffer?,__webglColorBuffer:three$WebGLGeometry$__webglColorBuffer@,__webglLineDistanceBuffer:three$WebGLGeometry$__webglLineDistanceBuffer@,three$WebGLGeometry$__webglUVBuffer,three$WebGLGeometry$__webglUV2Buffer,three$WebGLGeometry$__webglSkinVertexABuffer,three$WebGLGeometry$__webglSkinVertexBBuffer,three$WebGLGeometry$__webglSkinIndicesBuffer,three$WebGLGeometry$__webglSkinWeightsBuffer,__webglFaceBuffer:three$WebGLGeometry$__webglFaceBuffer<,__webglLineBuffer:three$WebGLGeometry$__webglLineBuffer<,__webglMorphTargetsBuffers:three$WebGLGeometry$__webglMorphTargetsBuffers<,three$WebGLGeometry$__webglMorphNormalsBuffers,__webglInit:three$WebGLGeometry$__webglInit@,__inittedArrays:three$WebGLGeometry$__inittedArrays<,__vertexArray:three$WebGLGeometry$__vertexArray@,three$WebGLGeometry$__normalArray,three$WebGLGeometry$__tangentArray,__colorArray:three$WebGLGeometry$__colorArray@,__lineDistanceArray:three$WebGLGeometry$__lineDistanceArray@,three$WebGLGeometry$__uvArray,three$WebGLGeometry$__uv2Array,three$WebGLGeometry$__skinVertexAArray,three$WebGLGeometry$__skinVertexBArray,three$WebGLGeometry$__skinIndexArray,three$WebGLGeometry$__skinWeightArray,three$WebGLGeometry$__faceArray,three$WebGLGeometry$__lineArray,three$WebGLGeometry$__morphTargetsArrays,three$WebGLGeometry$__morphNormalsArrays,__webglFaceCount:three$WebGLGeometry$__webglFaceCount<,__webglLineCount:three$WebGLGeometry$__webglLineCount@,three$WebGLGeometry$__webglParticleCount,three$WebGLGeometry$__webglVertexCount,three$WebGLGeometry$__sortArray,__webglCustomAttributesList:three$WebGLGeometry$__webglCustomAttributesList<"
  },
  WebGLObject: {
...
["vector_math", "package:vector_math/vector_math.dart", , T, {
  ...
  Vector2: {
    ...
    $add: function(_, other) {
      ...
      t2 = C.JSNumber_methods.$add(t1[1], t2.get$storage(other).$index(0, 1));
      t1 = new Float32Array(H._checkLength(2));
      t1[0] = t3;
      t1[1] = t2;
...
init.metadata = [{func: "void___Object", void: true, opt: [P.Object]},
,
